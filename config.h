...
static const char *schot[] = {"/usr/bin/flameshot", "full", "-p", "/home/pranav/images/ss", NULL};
static const char *schot_sel[] = {"/usr/bin/flameshot", "gui", NULL};
...
static Key keys[] = {
	...
	{ 0,                            XF86XK_AudioMicMute, spawn, SHCMD("pactl set-source-mute 1 toggle; pkill -RTMIN+10 dwmblocks") },
